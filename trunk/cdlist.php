...
include (dirname(__FILE__).'/database_config.php');
	...
	while($record = mysql_fetch_array($result))
	{
			...
			echo '<li onmouseover="openDes(\''.$ID.'\')" onmouseout="closeDes((\''.$ID.'\'))" ><a href="event.php?eventID='.$ID.'" ><img  src="'.$record['image'].'" border="0" alt="Image cannot be loaded" /><span id="'.$ID.'" class="caption" style="display:none">Countdown</span></a>';;
			echo '
